...
- (void)testWebViewDelegateLinkClicked2 {
    ...
    NSURLRequest *req = [NSURLRequest requestWithURL:[NSURL URLWithString:@"jails://?action=delegateAction2WithParam1:&param1=1&param2=2"]];
    [self.adapter webView:nil shouldStartLoadWithRequest:req navigationType:UIWebViewNavigationTypeLinkClicked];
    STAssertTrue(self.delegateAction2Called, @"delegateAction2Called");
}
...
- (void)testWebViewDelegateLinkClicked3 {
    ...
    NSURLRequest *req = [NSURLRequest requestWithURL:[NSURL URLWithString:@"jails://?action=delegateAction3WithParam1:param2:&param1=1&param2=2"]];
    [self.adapter webView:nil shouldStartLoadWithRequest:req navigationType:UIWebViewNavigationTypeLinkClicked];
    STAssertTrue(self.delegateAction3Called, @"delegateAction3Called");
...
- (void)testWebViewDelegateLinkClicked5 {
    NSURLRequest *req = [NSURLRequest requestWithURL:[NSURL URLWithString:@"jails://?action=delegateAction3WithDecodedParam1:param2:&param1=https%3A%2F%2Fwww.google.co.jp%2Fsearch%3Fq%3Dtest%2Bis%2Bok%26aq%3Df%26oq%3Dtest%2Bis%2Bok%26aqs%3Dchrome.0.57j0l2j62.5401j0%26sourceid%3Dchrome%26ie%3DUTF-8&param2=bbb"]];
//    NSURLRequest *req = [NSURLRequest requestWithURL:[NSURL URLWithString:@"jails://?action=delegateAction3WithDecodedParam1:param2:&param1=https://www.google.co.jp/search?q=test+is+ok&aq=f&oq=test+is+ok&aqs=chrome.0.57j0l2j62.5401j0&sourceid=chrome&ie=UTF-8&param2=bbb"]];
    [self.adapter webView:nil shouldStartLoadWithRequest:req navigationType:UIWebViewNavigationTypeLinkClicked];
    STAssertTrue(self.delegateAction3Called, @"delegateAction3Called");
